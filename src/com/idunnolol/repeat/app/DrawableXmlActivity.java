...
public class DrawableXmlActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_drawable_xml);
		...
		addDrawable(container, "shape_gradient2.xml", R.drawable.shape_gradient2, 100, 100);
